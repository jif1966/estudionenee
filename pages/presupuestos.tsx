  ...
  const handleExportWord = async () => {
    ...
    try {
        ...
        try {
            ...
            logoParaElDoc = [new Paragraph({ text: "Estudio Nenee", alignment: AlignmentType.RIGHT })];
        }
            ...
            sections: [{
                children: [
                    ...
                    new Table({
                        ...
                        rows: [
                            new TableRow({
                                children: [ new TableCell({ children: [new Paragraph({ text: "Descripción Detallada", bold: true })] }) ],
                            }),
                            ...items.filter(item => item.descripcion_cliente).map(item => new TableRow({
                                children: [ new TableCell({ children: [new Paragraph(item.descripcion_cliente || '')] }) ],
                            })),
                        ],
                    }),
                    new Paragraph({ text: " " }),
